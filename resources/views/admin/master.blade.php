...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
 <!-- Bootstrap Core CSS -->
<link href="{{ asset('source/css/bootstrap.css') }}" rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
<link href="{{ asset('source/css/style.css') }}" rel='stylesheet' type='text/css' />
<!-- Graph CSS -->
<link href="{{ asset('source/css/fontawesome.css') }}" rel="stylesheet"> 
<!-- jQuery -->
<!-- lined-icons -->
<link rel="stylesheet" href="{{ asset('source/css/icon-font.css') }}" type='text/css' />
<!-- //lined-icons -->
 <!-- Meters graphs -->
					...
					<div class="modal-content">
						...
						<div class="col-md-5 app-left mpl">
							...
							<div class="app-devices">
								...
								<a href="#"><img src="source/images/1.png" alt=""></a>
								<a href="#"><img src="source/images/2.png" alt=""></a>
								<div class="clearfix"> </div>
							</div>
						</div>
						<div class="col-md-7 app-image">
							<img src="source/images/apps.png" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
							</div>
				...
				<div class="menu-right">
					<div class="profile_details">		
						  <div class="col-md-4 serch-part">
							  ...
							  <!-- search-scripts -->
									<script src="{{ asset('source/js/classie.js') }}"></script>
									<script src="{{ asset('source/js/uisearch.js') }}"></script>
										<script>
									...
									<!-- //search-scripts -->
											 <!---->
											  <div class="col-md-4 player">
												...
												<!--audio-->
													<link rel="stylesheet" type="text/css" media="all" href="{{ asset('source/css/audio.css') }}">
													<script type="text/javascript" src="{{ asset('source/js/mediaelement-and-player.min.js') }}"></script>
													<!---->


												<!--//-->
												<ul class="next-top">
													<li><a class="ar" href="#"> <img src="source/images/arrow.png" alt=""/></a></li>
													<li><a class="ar2" href="#"><img src="source/images/arrow2.png" alt=""/></i></a></li>
										...
										<ul class="rslides callbacks callbacks1" id="slider4">
											   	<li>
														<div class="banner-img">
															 <img src="source/images/11.jpg" class="img-responsive" alt="">
														 </div>
												...
												<li>
													<div class="banner-img">
															 <img src="source/images/22.jpg" class="img-responsive" alt="">
														 </div>
														<div class="banner-info">
																	  <a class="trend" href="single.html">TRENDING</a>
...
<<<<<<< e88635d5b72cde6a7bc99b22c235b1322a9fa770:resources/views/admin/master.blade.php
...
=======
												...
												<li>
												 <div class="banner-img">
															 <img src="source/images/33.jpg" class="img-responsive" alt="">
														 </div>
														<div class="banner-info"> 
														             <a class="trend" href="single.html">TRENDING</a>
																	  <h3>Let Your Home</h3>
				...
				<!--//End-banner-->
					...
					<!--//pop-up-box -->
						<div class="albums">
								...
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v1.jpg" title="allbum-name"></a>
							...
							<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v2.jpg" title="allbum-name"></a>

								<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
							</div>
							<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v3.jpg" title="allbum-name"></a>
>>>>>>> Feature/#5.0-front end:resources/views/admin/index.blade.php

								<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
							</div>
							<div class="col-md-3 content-grid last-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v4.jpg" title="allbum-name"></a>
	
								<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
							</div>
							<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v5.jpg" title="allbum-name"></a>
...
=======
							...
							<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v6.jpg" title="allbum-name"></a>
		
								<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
							</div>
							<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v7.jpg" title="allbum-name"></a>

								<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
							</div>
							<div class="col-md-3 content-grid last-grid">
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog"><img src="source/images/v8.jpg" title="allbum-name"></a>
												<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
											</div>
											<div class="clearfix"> </div>
										</div>
					<!--//End-albums-->
						...
						<div class="albums second">
										<div class="tittle-head">
											...
											<div class="col-md-3 content-grid">
												<a href="single.html"><img src="source/images/v11.jpg" title="allbum-name"></a>
												<div class="inner-info"><a href="single.html"><h5>Pop</h5></a></div>
											</div>
											<div class="col-md-3 content-grid">
													<a href="single.html"><img src="source/images/v22.jpg" title="allbum-name"></a>
													<div class="inner-info"><a href="single.html"><h5>Pop</h5></a></div>
												</div>
											<div class="col-md-3 content-grid">
													<a href="single.html"><img src="source/images/v33.jpg" title="allbum-name"></a>
													<div class="inner-info"><a href="single.html"><h5>Pop</h5></a></div>
												</div>
											<div class="col-md-3 content-grid last-grid">
													<a href="single.html"><img src="source/images/v44.jpg" title="allbum-name"></a>
													<div class="inner-info"><a href="single.html"><h5>Pop</h5></a></div>
											</div>
											<div class="col-md-3 content-grid">
													<a href="single.html"><img src="source/images/v55.jpg" title="allbum-name"></a>
													<div class="inner-info"><a href="single.html"><h5>Pop</h5></a></div>
											</div>
											<div class="col-md-3 content-grid">
												<a href="single.html"><img src="source/images/v66.jpg" title="allbum-name"></a>
												<div class="inner-info"><a href="single.html"><h5>Pop</h5></a></div>
											</div>
											<div class="col-md-3 content-grid">
													<a href="single.html"><img src="source/images/v11.jpg" title="allbum-name"></a>
									...
									<div class="video-record-list">
										<div id="jp_container_1" class="jp-video jp-video-270p" role="application" aria-label="media player">
											<div class="jp-type-playlist">
												<div id="jquery_jplayer_1" class="jp-jplayer" style="width: 480px; height: 270px;"><img id="jp_poster_0" src="source/video/play1.png" style="width: 480px; height: 270px; display: inline;"><video id="jp_video_0" preload="metadata" src="source/video/Ellie-Goulding.webm" title="1. Ellie-Goulding" style="width: 0px; height: 0px;"></video></div>
												<div class="jp-gui">
				...
				$(document).ready(function(){
					...
					new jPlayerPlaylist({
						...
						
						{
							...
							artist:"",
							mp4: "source/video/Ellie-Goulding.mp4",
							ogv: "source/video/Ellie-Goulding.ogv",
							webmv: "source/video/Ellie-Goulding.webm",
							poster:"source/video/play1.png"
						},
						{
							title:"2. Mark-Ronson-Uptown",
							artist:"",
							mp4: "source/video/Mark-Ronson-Uptown.mp4",
							ogv: "source/video/Mark-Ronson-Uptown.ogv",
							webmv: "source/video/Mark-Ronson-Uptown.webm",
							poster:"source/video/play2.png"
						},
						{
						...
						},
						{
							...
							artist:"",
							mp4: "source/video/Maroon-Sugar.mp4",
							ogv: "source/video/Maroon-Sugar.ogv",
							webmv: "source/video/Maroon-Sugar.webm",
							poster:"source/video/play4.png"
						},
						{
							title:"5. Pharrell-Williams",
							artist:"",
							mp4: "source/video/Pharrell-Williams.mp4",
							ogv: "source/video/Pharrell-Williams.ogv",
							webmv: "source/video/Pharrell-Williams.webm",
							poster:"vvideo/play5.png"
						},
						{
						...
						},
						{
							...
							artist:"",
							mp4: "source/video/Pharrell-Williams.mp4",
							ogv: "vsource/ideo/Pharrell-Williams.ogv",
							webmv: "source/video/Pharrell-Williams.webm",
							poster:"source/video/play5.png"
						}
					], {
...
>>>>>>> Feature/#5.0-front end:resources/views/admin/index.blade.php
								...
								<!--/app_store-->
									  <div class="apps">
												<h3 class="hd-tittle">Framgia Imusic now available in</h3>
			 	 ...
			 	 <!-- /w3l-agile-its -->
						...
						<div class="review-slider">
								<div class="tittle-head">
								 ...
								 <ul id="flexiselDemo1">
								<li>
									<a href="single.html"><img src="source/images/v1.jpg" alt=""/></a>
								...
								<li>
									<a href="single.html"><img src="source/images/v2.jpg" alt=""/></a>
									<div class="slide-title"><h4>Adele22</h4></div>
									<div class="date-city">
										<h5>Jan-02-16</h5>
										<div class="buy-tickets">
											<a href="single.html">READ MORE</a>
								...
								<li>
									<a href="single.html"><img src="source/images/a10.jpg" alt=""/></a>
								...
								<li>
									<a href="single.html"><img src="source/images/v4.jpg" alt=""/></a>
								...
								<li>
									<a href="single.html"><img src="source/images/v5.jpg" alt=""/></a>
								...
								<li>
									<a href="single.html"><img src="source/images/a6.jpg" alt=""/></a>
								...
								<li>
									<a href="single.html"><img src="source/images/v6.jpeg" alt=""/></a>
...
<script src="{{ asset('source/js/jquery.nicescroll.js') }}"></script>
