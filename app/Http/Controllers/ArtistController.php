...
class ArtistController extends Controller
{
    ...
    {
        $image = $request->user_images;
        $image->move('user_images', config('custom.path_image') . $image->getClientOriginalName());
        $image->path = config('custom.path_image') . $image->getClientOriginalName();
